...
class RecipesListViewModelTest {
    ...
    @Test
    fun `Is recipe list empty when repository gives non empty response, returns false`() {
    ...
    @Test
    fun `Is recipe list empty when repository gives empty response, returns true`() {
